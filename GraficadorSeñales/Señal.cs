...
{
    //clase abstracta --> nomas sirve para ser heredara, llamar elem. de ella
    abstract class Señal
    {
        ...
        public void construirSeña()
        {
         ...
         public  Señal escalarAmplitud( Señal señalOriginal, double factorEscala)
        {
